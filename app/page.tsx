...
const reviews = [
  ...
  { quote: 'Rodeo Auto made everything simple. They worked with my budget and got me on the road the same afternoon.', name: 'Darius T.', meta: 'Verified Google review' },
...
export default function Page() {
  ...
  return (
    <main className="home-page min-h-screen bg-background text-foreground">
      <div className="topbar"><div className="container flex items-center justify-between gap-4"><span className="hidden sm:inline">Houston&apos;s trusted independent dealer since 2018</span><a href="tel:7137426320"><Phone data-icon="inline-start" /> (713) 742-6320</a><span className="hidden md:inline"><MapPin data-icon="inline-start" /> 8224 North Fwy · Houston, TX 77037</span></div></div>
      <header className="site-header"><div className="container flex items-center justify-between gap-6"><a href="/" className="brand" aria-label="Rodeo Auto home"><span className="brand-mark"><img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-Iqj5ixoT7n9F8Iae1sM0cEHKm68sbx.png" alt="Rodeo Auto logo" /></span></a><nav className="desktop-nav" aria-label="Primary navigation"><a href="#home">Home</a><a href="/cars-for-sale">Inventory <ChevronDown /></a><a href="/loan-application">Loan Application</a><a href="/car-finder">Car Finder</a><a href="/value-my-trade">Value My Trade</a><a href="/testimonial">Testimonials</a><div className="nav-dropdown"><button className="nav-dropdown-trigger" aria-expanded={aboutOpen} onClick={() => setAboutOpen(!aboutOpen)}>About <ChevronDown /></button>{aboutOpen && <div className="nav-dropdown-menu" role="menu"><a href="/about-us" role="menuitem" onClick={() => setAboutOpen(false)}>About Us <span>›</span></a><a href="https://pauto43912.vercel.app/rodeo-auto-merch" role="menuitem" onClick={() => setAboutOpen(false)}>Rodeo Auto Merch <span>›</span></a></div>}</div><a href="/payment">Make a Payment</a></nav><div className="header-actions"><a className="phone-link" href="tel:7137426320"><Phone /> <span className="hidden lg:inline">Call us</span></a><a className="button button-primary hidden sm:inline-flex" href="/cars-for-sale">Shop cars <ArrowRight /></a><button className="menu-button" aria-label={menuOpen ? 'Close menu' : 'Open menu'} onClick={() => setMenuOpen(!menuOpen)}>{menuOpen ? <X /> : <Menu />}</button></div></div>{menuOpen && <nav className="mobile-nav" aria-label="Mobile navigation"><a href="#home" onClick={() => setMenuOpen(false)}>Home</a><a href="/cars-for-sale" onClick={() => setMenuOpen(false)}>Inventory</a><a href="/loan-application" onClick={() => setMenuOpen(false)}>Loan Application</a><a href="/car-finder" onClick={() => setMenuOpen(false)}>Car Finder</a><a href="/value-my-trade" onClick={() => setMenuOpen(false)}>Value My Trade</a><a href="/testimonial" onClick={() => setMenuOpen(false)}>Testimonials</a><a href="/payment" onClick={() => setMenuOpen(false)}>Make a Payment</a><a href="#about" onClick={() => setMenuOpen(false)}>About</a></nav>}</header>

      <section id="home" className="hero"><div className="hero-overlay" /><div className="container hero-content"><div className="eyebrow"><span className="eyebrow-dot" /> Houston, TX · Open today until 7 PM</div><h1>A better car<br /><em>starts here.</em></h1><p>Quality pre-owned vehicles, transparent pricing, and a team that treats you like family. Find your next ride without the dealership runaround.</p><div className="hero-actions"><a className="button button-primary button-large" href="/cars-for-sale">Browse inventory <ArrowRight /></a><a className="button button-ghost button-large" href="/loan-application">Get pre-approved <ChevronRight /></a></div><div className="hero-proof"><div className="avatar-stack"><span>MR</span><span>DT</span><span>JL</span></div><div><div className="stars">★★★★★</div><strong>4.8 on Google</strong><span> · 200+ happy drivers</span></div></div></div><div className="hero-stamp"><span>HOUSTON</span><strong>AUTO</strong><small>Drive happy.</small></div></section>
      ...
      <section id="about" className="about-section"><div className="container about-grid"><div className="about-image"><img src="https://images.unsplash.com/photo-1562141961-8f7a8f5d7a0f?auto=format&fit=crop&w=1100&q=85" alt="Rodeo Auto team member standing beside a vehicle" /><div className="about-caption"><strong>Locally owned.</strong><span>Houston proud.</span></div></div><div className="about-copy"><span className="section-kicker">WHY AUTO</span><h2>Good cars.<br /><em>Good people.</em></h2><p>We started Rodeo Auto because buying a used car should feel exciting — not exhausting. Our small, local team is here to give Houston drivers a straightforward experience and a vehicle they can feel good about.</p><div className="about-stats"><div><strong>200+</strong><span>5-star reviews</span></div><div><strong>24</strong><span>cars in stock</span></div><div><strong>8 yrs</strong><span>serving Houston</span></div></div><a className="text-link" href="#contact">Meet the Rodeo Auto team <ArrowRight /></a></div></div></section>

      <section id="contact" className="contact-section"><div className="container contact-grid"><div><span className="section-kicker">COME SAY HELLO</span><h2>Your next car is<br /><em>waiting.</em></h2><p>Visit us in North Houston or give us a call. We&apos;ll have the coffee ready.</p><div className="contact-details"><a href="tel:7137426320"><Phone /> (713) 742-6320</a><span><MapPin /> 8224 North Fwy<br />Houston, TX 77037</span><span><Clock3 /> Mon–Sat: 9 AM–7 PM<br />Sun: 11 AM–5 PM</span></div></div><div className="map-card"><div className="map-lines" /><div className="map-pin"><MapPin fill="currentColor" /></div><div className="map-label"><strong>Rodeo Auto</strong><span>8224 North Fwy, Houston</span><a href="https://www.google.com/maps/search/?api=1&query=Rodeo+Auto+8224+North+Fwy+Houston+TX" target="_blank" rel="noreferrer">Get directions <ArrowUpRightIcon /></a></div></div></div></section>

      <footer className="footer"><div className="container footer-top"><a href="#home" className="brand brand-light"><span className="brand-mark"><img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-Iqj5ixoT7n9F8Iae1sM0cEHKm68sbx.png" alt="Rodeo Auto logo" /></span></a><p>Quality cars. Honest deals.<br />A better way to buy.</p><div className="footer-links"><a href="/cars-for-sale">Inventory</a><a href="/loan-application">Financing</a><a href="/value-my-trade">Value my trade</a><a href="#contact">Contact</a></div><div className="socials"><a href="#contact" aria-label="Facebook"><Link /></a><a href="#contact" aria-label="Instagram"><Link /></a><a href="#contact" aria-label="Youtube"><Link /></a></div></div><div className="container footer-bottom"><span>© 2026 Rodeo Auto. All rights reserved.</span><span>Houston, Texas · Dealer license available upon request</span></div></footer><a className="mobile-call" href="tel:7137426320"><Phone /> Call Rodeo Auto</a>
    </main>
  )
}
